            ...
            <ul class="navbar-nav mr-auto ml-auto">
              ...
              <li class="nav-item">
               <!-- <a class="nav-link" href="">
                  Login</a> -->
                  <button type="button" class="nav-link" data-toggle="modal" data-target="#loginModal">
                    Login
                  </button> 
              </li>
            </ul>
            ...
            <div class="mh-header-info">
              ...
              <ul>
                <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fa fa-envelope"></i><a
                    href="mailto:">yeasirarefin@just.edu.bd</a></li>
                ...
                <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i>
                  <address>Anabil 34/3, Ukilpara, Sunamganj, Bangladesh</address>
                </li>
              </ul>
      ...
      <div class="row section-separator">
        ...
        <div class="part col-sm-12">
          <div class="portfolio-nav col-sm-12" id="filter-button">
            <ul>
              <li data-filter="*" class="current wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s"> <span>All
                  Categories</span></li>
              <li data-filter=".user-interface" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <span>Web Design</span>
              </li>
              <li data-filter=".branding" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                <span>Branding</span>
              </li>
              <li data-filter=".mockup" class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                <span>Mockups</span>
              </li>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-4">
                <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s"
                  ...
                  <div class="each-info">
                    <h4>Address</h4>
                    <address>
                      Anabil 34/3, Ukilpara, Sunamganj<br>
                      Bangladesh
                    </address>
                  </div>
                </div>
              ...
              <div class="col-sm-12 col-md-4">
                <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s"
                  ...
                  <div class="each-info">
                    <h4>Email</h4>
                    <a href="mailto:yourmail@email.com">yeasirarefin@just.edu.bd</a><br>
